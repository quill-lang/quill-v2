...
\begin{mathpar}
\inferrule*[right=Var]{\langle x, \sigma, \rho \rangle \in \Gamma}{\Gamma \vdash x : \sigma, \rho}
\end{mathpar}
...
Lifetimes are not considered to be part of an object's type.
