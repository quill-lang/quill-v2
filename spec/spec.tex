...
\begin{mathparpagebreakable}
  ...
  \inferrule*[right=$\mathcal B$-\rcomp]
    {\oftp{\Gamma}{A}{\UU} \\
     ...
     \oftp{\Gamma}{g}{\tprd{x:A} C(\beta(x))} \\
     \oftp\Gamma{a}{A}}
    {\jdeqtp\Gamma{\ind{\mathcal B(A)}(C,g,\beta(a))}{g(a)}{C(\beta(a))}}
\end{mathparpagebreakable}

% TODO: prove uniqueness rules and the existence of recursors
